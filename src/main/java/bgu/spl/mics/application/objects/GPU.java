        ...
        if(processedDBs.size()<MaxNumOfProcessedBatches){
            ...
            if(dataBatch!=null) {
                ...
                if (status == GPUStatus.Waiting) {
                    //System.out.println("GPU " + this.type+ " status is:" + status);
                    startTraining();
                }
            }
        }
    ...
    * @post: model.getStatus() == Training
    ...
    public void startTraining(){
        if(!processedDBs.isEmpty()){
            ...
            //System.out.println("GPU " + this.type+ " started training model: " + model.getName());
            //System.out.println("GPU " + this.type+ " status is:" + status);
        }
    }
...
//        System.out.println("GPU " + this.type+ " entered doneTraining, num of trained dbs:" + numOfTrainedDBs+
//                ", num of total: "+ numOfTotalDBs);
    ...
    public void complete(){
        ...
        //System.out.println("GPU " + this.type+ " finished training model: " + model.getName());
    }
